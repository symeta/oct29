...
- [1.Placement Group](https://aws.amazon.com/blogs/industries/crypto-market-making-latency-and-amazon-ec2-shared-placement-groups/)

## local zone

- [1.local zone intro](https://aws.amazon.com/about-aws/global-infrastructure/localzones/features/?pg=localzones&sec=hs)
- [2.local zone blog1](https://aws.amazon.com/cn/blogs/industries/rethinking-the-low-latency-trade-value-proposition-using-aws-local-zones/)
- [3.local zone blog2](https://aws.amazon.com/cn/blogs/industries/new-aws-local-zones-deliver-lower-latency-in-chicago-and-new-york-city/)

## s3 express one zone
- [1.s3 express one zone intro](https://aws.amazon.com/s3/storage-classes/express-one-zone/)
